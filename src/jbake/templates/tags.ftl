...
<div class="page-header">
  <div class="row">
    <div class="col-xs-6 col-md-3"><h2><span class="label label-primary">${tag}</span></h2></div>
    <div class="col-md-offset-7 col-xs-offset-4 col-xs-2 col-md-2"><h2><i class="fa fa-book"></i> ${tag_posts?size}</h2></div>
  </div>
</div>
  ...
  <div class="row">
	...
	<#else>
        ...
        <a href="${post.uri}" class="list-group-item">${post.title}</a>
